...
public class HomeInventory extends JFrame{
    ...
    public HomeInventory(){
        ...
        Dimension bSize = new Dimension(70, 56);
        ImageIcon imageIcon;
        Image image;
        
        inventoryToolBar.addSeparator();
        //newButton
        imageIcon = new ImageIcon("img/add-file1.png");
        image = imageIcon.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
        ...
        //deleteButton
        imageIcon = new ImageIcon("img/bin.png");
        image = imageIcon.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
        ImageIcon deleteImageIcon = new ImageIcon(image);
        ...
        //saveButton(Save)
        imageIcon = new ImageIcon("img/diskette.png");
        image = imageIcon.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
        ImageIcon saveImageIcon = new ImageIcon(image);
        ...
        imageIcon = new ImageIcon("img/previous.png");
        image = imageIcon.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
        ImageIcon previousImageIcon = new ImageIcon(image);
        previousButton.setIcon(previousImageIcon);
        ...
        //nextButton(Next)
        imageIcon = new ImageIcon("img/next.png");
        image = imageIcon.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
        ImageIcon nextImageIcon = new ImageIcon(image);
        nextButton.setIcon(nextImageIcon);
        ...
        //printButton(Print)
        imageIcon = new ImageIcon("img/printer.png");
        image = imageIcon.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
        ImageIcon printImageIcon = new ImageIcon(image);
        printButton.setIcon(printImageIcon);
        ...
        //exitButton(Exit)
        imageIcon = new ImageIcon("img/exit.png");
        image = imageIcon.getImage().getScaledInstance(50, 35, Image.SCALE_SMOOTH);
        ImageIcon exitImageIcon = new ImageIcon(image);
        ...
        int n;
        try{
            BufferedReader inputFile = new BufferedReader(new FileReader("file/inventory.txt"));
    ...
    private void exitForm(WindowEvent evt){
        if(JOptionPane.showConfirmDialog(null, "Any unsaved change will be lost.\nAre you sure you want to exit?", "Exit Program",
                JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.NO_OPTION){
            return;
        }
        try{
            PrintWriter outputFile = new PrintWriter(new BufferedWriter(new FileWriter("file/inventory.txt")));
    ...
    private void checkSave(){
        ...
        if(!myInventory[currentEntry - 1].description.equals(itemTextField.getText()))
            ...
            edited = true; 
        if(edited){
            if(JOptionPane.showConfirmDialog(null, "You have edited this item. Do you want to save changes?", "Save Item",
...
class InventoryDocument implements Printable{
    public int print(Graphics g, PageFormat pf, int pageIndex){
        ...
        for(i=0+HomeInventory.entriesPerPage*pageIndex; i<iEnd; i++){
            ...
            g2D.setFont(new Font("Arial", Font.BOLD, 12));
            g2D.drawString("Price: $"+HomeInventory.myInventory[i].purchasePrice, (int)pf.getImageableX()+25, y);
            y += dy;
